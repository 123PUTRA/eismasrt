...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            ...
            <p>Tanggal : <?php echo e($event->tanggal); ?></p>
            <p>Lokasi : <?php echo e($event->lokasi); ?></p>
        </div>
        <div class="col-md-6">
    ...
    <div class="table-responsive">
        <table class="table" id="registration-table">
            ...
            <tbody>
                ...
                <tr id="registration-<?php echo e($registration->id); ?>">
                    <td><?php echo e($registration->nama); ?></td>
                    <td><?php echo e($registration->email); ?></td>
                    <td><?php echo e($registration->prodi); ?></td>
                    <td><?php echo e($registration->semester); ?></td>
                    <td><input type="checkbox" class="custom-checkbox" id="checkbox-<?php echo e($registration->id); ?>"></td>
                </tr>
...
<?php /**PATH C:\laragon\www\eismart\resources\views/info.blade.php ENDPATH**/ ?>