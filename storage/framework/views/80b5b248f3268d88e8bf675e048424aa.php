...
<head>
    ...
    <style>
        ...
        .form-control {
            background-color: #294b29; /* Warna input field */
            color: white; /* Warna teks input field */
            border: 1px solid #538d53; /* Border input field */
            border-radius: 7px; /* Border radius untuk membuat sudut elemen lebih bulat */
        }
        .btn-primary {
...
<?php /**PATH C:\laragon\www\eismart\resources\views/registerevent.blade.php ENDPATH**/ ?>