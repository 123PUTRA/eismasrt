            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <p class="card-text">Tanggal: <?php echo e($event->tanggal); ?></p>
                        <p class="card-text">Lokasi: <?php echo e($event->lokasi); ?></p>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="<?php echo e(route('registrasi.formep')); ?>" class="btn btn-dark">Daftar</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\eismart\resources\views/detail.blade.php ENDPATH**/ ?>